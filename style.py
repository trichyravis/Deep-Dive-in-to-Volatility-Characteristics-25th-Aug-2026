...
[data-testid="stTabs"] button{color:#51677f!important;font-weight:700;opacity:1!important}[data-testid="stTabs"] button *{color:inherit!important;opacity:1!important}[data-testid="stTabs"] button:hover{color:var(--blue)!important}[data-testid="stTabs"] button[aria-selected="true"]{color:var(--navy-dark)!important;border-bottom-color:#ffd400!important}
